 ...
 * @author m
 */
public class professeurFenetre extends javax.swing.JFrame {
    ...
    /**
     * Creates new form professeurFenetre
     */
    ...
    private void initComponents() {
        ...
        tfGrade.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
    ...
    private void btnAjouterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAjouterActionPerformed
        ...
        String nom = tfNomDep.getText();
        String prenom = tfGrade.getText();
        String nomDep = tfNomDep.getText();
        
        if (id.isEmpty() || nom.isEmpty() || prenom.isEmpty() || nomDep.isEmpty()){
            ...
            DefaultTableModel model = (DefaultTableModel) tableEtudiants.getModel();
            model.addRow(new Object[]{id, nom, prenom, nomDep});
            
            String query = "INSERT INTO GestionEtudiants (id, nom, prenom, nomDep) VALUES (?, ?, ?, ?)";
    ...
    private void btnModifierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifierActionPerformed
        ...
        if (row < 0) {
            ...
            if (nom.isEmpty() || prenom.isEmpty() || nomDep.isEmpty()) {
                JOptionPane.showMessageDialog(this,
                        "SVP Saisir tous les champs.",
                        "Essayer à nouveau.",
                        JOptionPane.ERROR_MESSAGE);
                ...
                model.setValueAt(nomDep, row, 3);

                String query = "UPDATE GestionEtudiants SET nom=?, prenom=?, nomDep=? WHERE id=?";
                try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/GestionEtudiants", "root", "");
                     PreparedStatement statement = connection.prepareStatement(query)) {
                    statement.setString(1, nom);
                    statement.setString(2, prenom);
                    statement.setString(3, nomDep);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new professeurFenetre().setVisible(true);
            }
        });

        try {
            
            Connection cnt = DriverManager.getConnection("jdbc:mysql://localhost:3306/GestionProfesseur","root","");
