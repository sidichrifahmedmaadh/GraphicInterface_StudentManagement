 ...
 * @author m
 */
public class etudiantFene extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfNom.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel3.setText("Prenom");

        tfPrenom.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
    ...
    private void btnAjouterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAjouterActionPerformed
        ...
        if (id.isEmpty() || nom.isEmpty() || prenom.isEmpty() || filiere.isEmpty()){
            ...
            DefaultTableModel model = (DefaultTableModel) tableEtudiants.getModel();
            model.addRow(new Object[]{id, nom, prenom, filiere});
            
            String query = "INSERT INTO GestionEtudiants (id, nom, prenom, filiere) VALUES (?, ?, ?, ?)";
    ...
    private void btnModifierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifierActionPerformed
        ...
        if (row < 0) {
            ...
            if (nom.isEmpty() || prenom.isEmpty() || filiere.isEmpty()) {
                ...
                model.setValueAt(filiere, row, 3);

                String query = "UPDATE GestionEtudiants SET nom=?, prenom=?, filiere=? WHERE id=?";
                try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/GestionEtudiants", "root", "");
                     PreparedStatement statement = connection.prepareStatement(query)) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new etudiantFene().setVisible(true);
            }
        });

        try {
            
            Connection cnt = DriverManager.getConnection("jdbc:mysql://localhost:3306/GestionEtudiants","root","");
